                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <div class="bg-blue-50 rounded-lg p-6">
                                        ...
                                        <div class="space-y-3">
                                            <div>
                                                ...
                                                <div class="font-medium">
                                                    ...
                                                    @else
                                                        <span class="text-green-600">{{ $user['review_status'] }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        ...
                                        @if($user['review_status'] == "")
                                            <div class="mt-4">
                                                <form action="/upload/review?provider={{ $user['provider_id'] }}&user={{ $user['user_id'] }}" method="POST" enctype="application/json">
                                                    @csrf
                                                    <div class="space-y-3">
                                                        <div>
                                    ...
                                    <div class="bg-gray-50 rounded-lg p-6">
                                        ...
                                        @else
                                            <div class="space-y-3">
                                                ...
                                                <form action="/task/success" class="mb-3">
                                                    <input type="number" name="pv_id" value="{{ $user['provider_id'] }}" style="display:none">
                                                    <button id='success' 
                                                            type="submit"
